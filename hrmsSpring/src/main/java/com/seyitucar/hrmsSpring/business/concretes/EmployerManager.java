...
public class EmployerManager implements EmployerService {
	...
	public Result update(Employer employer) {
		Employer updEmployer = this.employerDao.getById(employer.getId());
		updEmployer.setPassword(employer.getPassword());
		this.employerDao.save(updEmployer);
	...
	public Result delete(int id) {
		...
		return new SuccessResult("Çalışan profili silindi");
	}
